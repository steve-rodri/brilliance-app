        ...
        {mobile ? (
          ...
          <Fragment>
            ...
            <nav>
              ...
              <Link
                to={{
                  pathname: `/${accessLevel}/inventory`,
                  state: { nav: false }
                }}
              >
                <h2>Inventory</h2>
        ...
        {displayNav ? (
          <div className="Header--drop-down">
            <div
              ...
              style={
                location && location.pathname === `/${accessLevel}`
                  ? { gridAutoFlow: "row", gridRow: "span 2", fontSize: "2em" }
                  : {}
              }
            >
              <Link
            ...
            {view !== "Dashboard" ? <NavSection {...this.props} /> : null}
