        ...
        return (
          <thead className="Invoice--header">
            <tr className="Invoice--header-row">
              {editMode ? (
                <th className="Invoice--header-cell Invoice--header-edit"></th>
              ) : null}
              {(editMode && !mobile) || (!editMode && this.quantities()) ? (
                <th className="Invoice--header-cell Invoice--header-quantity">
                  <h4>Qty</h4>
                </th>
              ) : null}
              <th className="Invoice--header-cell Invoice--header-item">
                <h4>Item</h4>
              </th>
              {editMode && !mobile ? (
                <th className="Invoice--header-cell Invoice--header-inc">
                  <h4>Inc</h4>
                </th>
              ) : null}
              {!mobile ? (
                <th className="Invoice--header-cell Invoice--header-price">
                  <h4
                    style={
                      editMode
                        ? { textAlign: "center" }
          ...
          <thead>
            <tr>
              <td style={{ color: "var(--light-gray)" }}>
                ...
                <p>
                  Add items by clicking the pencil icon at the top right corner
                  of this screen.
                </p>
              </td>
            </tr>
      ...
      <div className="Invoice--container">
        <div className="Invoice">
          <table>
            ...
            <tbody className="Invoice--body">{this.lines()}</tbody>
          </table>
