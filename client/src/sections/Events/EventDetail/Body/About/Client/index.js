        ...
        if (isValidEmail(companyEmail)) {
          ...
          this.setState(prevState => ({
            formData: {
              ...
              company: {
                ...prevState.formData.company,
                email_addresses_attributes: [{ id: newEmail.id }]
              }
            }
          }));
        }
        ...
        this.setState(prevState => {
          ...
          if (type === "contact") {
            applyState.formData = {
              ...
              contact: {
                ...prevState.formData.contact,
                email_addresses_attributes: [{ id: emailData[index].id }]
              }
            };
          }
          if (type === "company") {
        ...
        <Fragment>
          ...
          companyEmailData ? (
            <Fragment>
              ...
              >
                <p>{`Create ${
                  view === "createCompany" ? "Company" : "Contact"
                }`}</p>
              </button>
            </Fragment>
          ) : (
  ...
  render() {
    ...
    return (
      <div className="CreateClient">
        ...
        <div className="CreateClient--content">{this.content()}</div>
        <div className="CreateClient--footer">{this.footer()}</div>
      </div>
    );
  }
}
