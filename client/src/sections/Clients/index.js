    ...
    return (
      <Fragment>
        <Switch location={isModal ? this.previousLocation : location}>
          ...
          <Route
            exact
            path={`${match.path}/:id/events`}
            render={props => this.ListEvents(props)}
          />
        </Switch>
        ...
        {isModal ? (
          <Switch>
            <Route
              exact
              path={`${match.path}/new`}
              render={props => this.Create(props, this.previousLocation)}
            />
            <Route
              exact
              path={`${match.path}/:id`}
              render={props => this.Show(props, this.previousLocation)}
            />
          </Switch>
        ) : null}
      </Fragment>
